...
if (NOT INTERN_BUILD_MOBILE)
  ...
  SET(AT_DNNL_ENABLED 0)
  SET(CAFFE2_USE_DNNL OFF)
  IF (USE_DNNL)
    INCLUDE(${CMAKE_CURRENT_LIST_DIR}/public/dnnl.cmake)
    IF(DNNL_FOUND)
      SET(AT_DNNL_ENABLED 1)
      INCLUDE_DIRECTORIES(AFTER SYSTEM ${DNNL_INCLUDE_DIR})
      IF(BUILD_CAFFE2_OPS)
        SET(CAFFE2_USE_DNNL ON)
        LIST(APPEND Caffe2_PUBLIC_DEPENDENCY_LIBS caffe2::dnnl)
      ENDIF(BUILD_CAFFE2_OPS)
    ELSE()
      MESSAGE(WARNING "DNNL could not be found.")
    ENDIF()
  ELSE()
    MESSAGE("disabling DNNL because USE_DNNL is not set")
  ENDIF()
