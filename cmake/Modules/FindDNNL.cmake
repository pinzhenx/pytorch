...
IF (NOT DNNL_THREADING)
  SET(DNNL_THREADING "OMP:COMP" CACHE STRING "")
ELSEIF (DNNL_THREADING STREQUAL "TBB")
  IF (USE_TBB)
  ...
  ELSE()
    MESSAGE(FATAL_ERROR "DNNL_THREADING is set to TBB but TBB is not used")
  ENDIF()
ENDIF()
MESSAGE(STATUS "DNNL_THREADING = ${DNNL_THREADING}")
