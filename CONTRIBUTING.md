  ...
  * [src](aten/src)
    ...
    * [ATen](aten/src/ATen)
      ...
      * [native](aten/src/ATen/native) - Modern implementations of
        ...
        * [mkl](aten/src/ATen/native/mkl) [dnnl](aten/src/ATen/native/dnnl)
...
variables `DEBUG`, `USE_DISTRIBUTED`, `USE_DNNL`, `USE_CUDA`, `BUILD_TEST`, `USE_FBGEMM`, `USE_NNPACK` and `USE_QNNPACK`.

- `DEBUG=1` will enable debug builds (-g -O0)
- `REL_WITH_DEB_INFO=1` will enable debug symbols with optimizations (-g -O3)
- `USE_DISTRIBUTED=0` will disable distributed (c10d, gloo, mpi, etc.) build.
- `USE_DNNL=0` will disable using DNNL.
...
For example:
```bash
DEBUG=1 USE_DISTRIBUTED=0 USE_DNNL=0 USE_CUDA=0 BUILD_TEST=0 USE_FBGEMM=0 USE_NNPACK=0 USE_QNNPACK=0 python setup.py develop
```
