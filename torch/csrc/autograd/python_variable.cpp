...
PyObject *THPVariable_is_dnnl(THPVariable *self, void *unused)
{
  HANDLE_TH_ERRORS
  auto& self_ = self->cdata;
  return torch::autograd::utils::wrap(self_.is_dnnl());
  END_HANDLE_TH_ERRORS
}
...
static struct PyGetSetDef THPVariable_properties[] = {
  ...
  {"is_dnnl", (getter)THPVariable_is_dnnl, nullptr, nullptr, nullptr},
